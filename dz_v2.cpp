...
class AlreadyExistException : std::exception //уже существует
{
public:
...
class DoesntExistException : std::exception //не существует
{
public:
...
{
public:
	class BadNameException : std::exception //плохое имя
	{
	public:
...
{
public:
	class ReadOnlyException : std::exception
	{
	public:
	...
	class OwnerException : std::exception   //когда пользователь пытается редактировать не свой файл 
	{
	public:
	...
	class ClosedException : std::exception    //закрытые файлы редактировать нельзя С:
	{
	public:
